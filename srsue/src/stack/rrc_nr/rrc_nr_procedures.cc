...
// -------------------------- Reconfiguration with Handover ----------------------------- 

rrc_nr::connection_reconf_ho_proc::connection_reconf_ho_proc(rrc_nr& parent_) : rrc_handle(parent_), initiator(nr)
{}

proc_outcome_t rrc_nr::connection_reconf_ho_proc::init(const reconf_initiator_t         initiator_,
                                                          const bool                       endc_release_and_add_r15,
                                                          const asn1::rrc_nr::rrc_recfg_s& rrc_nr_reconf)
{
  Info("Starting reconf (HO)...");
...
void rrc_nr::connection_reconf_ho_proc::then(const srsran::proc_state_t& result)
{
...
// -------------------------- Reconfiguration without Handover -----------------------------
